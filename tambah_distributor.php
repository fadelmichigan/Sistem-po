...
<html lang="id">
<head>
    <title>Dashboard Admin - Tambah Distributor</title>
...
<div class="main-content">
    ...
    <div class="main-header">
        <h2 class="mb-0">Tambah Distributor Baru</h2>
        <a href="distributor.php" class="btn btn-secondary">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="simpan_distributor.php" method="POST">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary w-100">Simpan Distributor</button>
            </form>
        </div>
    </div>
